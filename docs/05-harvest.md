...
>   [`06-dynamic-tools.md`](06-dynamic-tools.md) §3 — the part explicitly left **unresolved**. A tool
...
[`06-dynamic-tools.md`](06-dynamic-tools.md): the `promptGuidelines` bullets appended flat with no
