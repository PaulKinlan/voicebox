 ...
 */
export function createLiveSession({ onAudioOut, onText, onState, onToolCall, onDebug, log = console.error, provider, model, tools, systemInstruction, instruction, projectInstruction, voice } = {}) {
  ...
  try {
    inner = create({ model, emit, log, transport, tools, systemInstruction, instruction, projectInstruction, voice, debug });
  } catch (err) {
