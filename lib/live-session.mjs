 ...
 */
export function createLiveSession({ onAudioOut, onText, onState, onToolCall, onDebug, log = console.error, provider, model, tools, systemInstruction } = {}) {
  ...
  try {
    inner = create({ model, emit, log, transport, tools, systemInstruction, debug: onDebug ? debug : undefined });
  } catch (err) {
