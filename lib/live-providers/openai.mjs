...
//
// WHAT I DID NOT VERIFY, stated rather than assumed: the OUTPUT sample rate. The docs show a `rate` for the
// input format; the output format is shown as `audio/pcm` without one. This provider declares 24000 — the
// PCM16 default the API documents for input — and flags it here so a real drive is what settles it, not a
// reader's confidence.
...
export const OPENAI_INPUT_RATE = 24000;
export const OPENAI_OUTPUT_RATE = 24000;

export function createOpenAIProvider({ model, emit, log, transport }) {
