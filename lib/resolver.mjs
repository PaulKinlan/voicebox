...
const RESOLVER_SYSTEM = [
  ...
  "- write: create or overwrite a file. name = the file name (a plain name, no directories), content = EVERYTHING after \"with\" or \"containing\", verbatim — never paraphrase, truncate or drop words.",
