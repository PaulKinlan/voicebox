...
registerResolver("script", (transcript) => {
  ...
  return { unresolved: `the script resolver only knows create/read/list/delete/edit/diff/grep/list_agents/delegate_task/contact_agent/launch_mini_app — got: "${transcript.slice(0, 80)}". Wire a model resolver to go further.` };
});
